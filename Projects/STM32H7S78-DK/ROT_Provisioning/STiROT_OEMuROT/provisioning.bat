...
:: ============================================= OEMuROT application images generation steps =============================================
echo;
echo Step 3: OEMuROT application image generation
echo;
