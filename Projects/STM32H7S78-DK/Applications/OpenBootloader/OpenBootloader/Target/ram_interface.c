...
{
  RAM_MEM_START_ADDRESS + OPENBL_RAM_SIZE, /* OPENBL_RAM_SIZE is added to protect OpenBootloader RAM area */
  RAM_MEM_END_ADDRESS,
  RAM_MEM_SIZE,
  RAM_AREA,
  OPENBL_RAM_Read,
...
/**
  ...
  * @retval None.
  */
void OPENBL_RAM_Write(uint32_t address, uint8_t *p_data, uint32_t datalength)
{
  uint32_t index;
