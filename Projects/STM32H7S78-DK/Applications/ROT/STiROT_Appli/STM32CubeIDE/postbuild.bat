...
::=============================================================================================
set code_image_file="%provisioning_dir%\STiROT\Image\STiROT_Code_Image.xml"
...
set bin_location=%project_dir%..\Binary
:: Copy application build in Binary location
if not exist "%bin_location%" (
mkdir "%bin_location%"
)

copy %project_dir%\%config%\STM32H7S78-DK_STiROT_Appli.bin %project_dir%\..\Binary\appli.bin
