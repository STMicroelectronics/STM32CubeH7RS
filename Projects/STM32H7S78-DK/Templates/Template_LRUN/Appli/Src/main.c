...
#error "Compiler toolchain is unsupported"
  ...
  /* Initialize the DMA buffer region for section dma_buffer */
#if defined ( __ICCARM__ )
  /* get the region attribute form the icf file */
  extern uint32_t RW_NONCACHEABLEBUFFER_start;
  extern uint32_t RW_NONCACHEABLEBUFFER_size;

  address = (uint32_t)&RW_NONCACHEABLEBUFFER_start;
  size = (uint32_t)&RW_NONCACHEABLEBUFFER_size;
