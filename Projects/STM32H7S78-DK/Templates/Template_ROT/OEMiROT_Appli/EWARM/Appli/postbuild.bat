...
::=============================================================================================
set code_image_file="%provisioningdir%\%bootpath%\Images\%project%_Code_Image.xml"
...
%stm32tpccli% -pb "%provisioningdir%\%bootpath%\Images\%project%_Code_Image.xml" >> %current_log_file% 2>>&1
IF !errorlevel! NEQ 0 goto :error
exit 0
