## <b>GFXTIM_AbsoluteTimer_LineCount Example Description</b>
...
Based on the GFXTIM bus frequency (APB5_Freq = 150 MHz), the Line clock counter is configured to generate a Line clock at 1 KHz:

	Line clock counter CLK source = APB5_Freq
	Line clock counter Auto-reload = (APB5_Freq / 1000) - 1
	=> Line CK = 1 KHz
...
File                                                                                     | Description
 ---                                                                                     | ---
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Inc/main.h                                 |  Header for main.c module
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Inc/stm32h7s78_discovery_conf.h            |  BSP Configuration file
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Inc/stm32h7rsxx_it.h                       |  Interrupt handlers header file
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Inc/stm32h7rsxx_hal_conf.h                 |  HAL configuration file
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Src/main.c                                 |  Main program
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Src/stm32h7rsxx_hal_msp.c                  |  HAL MSP module
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Src/stm32h7rsxx_it.c                       |  Interrupt handlers
  GFXTIM/GFXTIM_AbsoluteTimer_LineCount/Appli/Src/system_stm32h7rsxx.c                   |  STM32H7RSxx system source file
