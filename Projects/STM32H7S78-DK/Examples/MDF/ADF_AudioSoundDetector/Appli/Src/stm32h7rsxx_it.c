...
/**
  * @brief This function handles ADF1 Filter 0 global Interrupt.
  */
void ADF1_FLT0_IRQHandler(void)
{
  /* USER CODE BEGIN ADF1_FLT0_IRQn 0 */

  /* USER CODE END ADF1_FLT0_IRQn 0 */
  HAL_MDF_IRQHandler(&AdfHandle0);
  /* USER CODE BEGIN ADF1_FLT0_IRQn 1 */

  /* USER CODE END ADF1_FLT0_IRQn 1 */
}
