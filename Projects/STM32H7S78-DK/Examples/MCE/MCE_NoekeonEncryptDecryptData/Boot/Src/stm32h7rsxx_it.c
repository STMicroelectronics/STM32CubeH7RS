...
/* USER CODE BEGIN EV */
extern MCE_HandleTypeDef  hmce;
extern XSPI_HandleTypeDef XSPIHandle[2];
...
/* USER CODE BEGIN 1 */
/**
  * @brief  This function handles HSPI1 interrupt request.
  * @param  None
  * @retval None
  */
void HSPI1_IRQHandler(void)
{
  HAL_XSPI_IRQHandler(&XSPIHandle[0]);
}
/* USER CODE END 1 */
