...
void HAL_MCE_MspInit(MCE_HandleTypeDef* hmce)
{
  ...
  {
  /* USER CODE BEGIN MCE2_MspInit 0 */

  /* USER CODE END MCE2_MspInit 0 */
    /* Peripheral clock enable */
    __HAL_RCC_XSPI2_CLK_ENABLE();
  /* USER CODE BEGIN MCE2_MspInit 1 */

  /* USER CODE END MCE2_MspInit 1 */
  }
...
void HAL_MCE_MspDeInit(MCE_HandleTypeDef* hmce)
{
  ...
  {
  /* USER CODE BEGIN MCE2_MspDeInit 0 */

  /* USER CODE END MCE2_MspDeInit 0 */
    /* Peripheral clock disable */
    __HAL_RCC_XSPI2_CLK_DISABLE();
  /* USER CODE BEGIN MCE2_MspDeInit 1 */

  /* USER CODE END MCE2_MspDeInit 1 */
  }
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  /* USER CODE BEGIN XSPI2_MspDeInit 0 */
   HAL_GPIO_DeInit(GPION, GPIO_PIN_0|GPIO_PIN_11
