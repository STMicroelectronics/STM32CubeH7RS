...
static void LCD_SetHint(void)
{
  ...
  UTIL_LCD_DisplayStringAt(0, 45, (uint8_t *)"This example shows the different LCD features,", CENTER_MODE);
  UTIL_LCD_DisplayStringAt(0, 60, (uint8_t *)"use USER push-button to display next page", CENTER_MODE);
