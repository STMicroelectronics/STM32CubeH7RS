...
static void HAL_FMC_MspInit(void){
  ...
  */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_1|GPIO_PIN_6
                          |GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_3|GPIO_PIN_7
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_0
                          |GPIO_PIN_1|GPIO_PIN_5|GPIO_PIN_8|GPIO_PIN_7
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_7|GPIO_PIN_1|GPIO_PIN_4
                          |GPIO_PIN_0|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_0|GPIO_PIN_11|GPIO_PIN_10
                          |GPIO_PIN_9|GPIO_PIN_2|GPIO_PIN_7|GPIO_PIN_8
...
//
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOD, GPIO_PIN_3|GPIO_PIN_7|GPIO_PIN_1|GPIO_PIN_4
                          |GPIO_PIN_0|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_12);
  ...
  HAL_GPIO_DeInit(GPIOB, GPIO_PIN_15|GPIO_PIN_2|GPIO_PIN_1);
