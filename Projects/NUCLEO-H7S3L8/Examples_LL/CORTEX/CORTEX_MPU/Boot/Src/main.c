...
static void MPU_Config(void)
{
  ...
  */
  ...
  /** Initializes and configures the Region and the memory to be protected
  */
  LL_MPU_ConfigRegion(LL_MPU_REGION_NUMBER2, 0x0, 0x24020000, LL_MPU_REGION_SIZE_256B|LL_MPU_TEX_LEVEL0|LL_MPU_REGION_PRIV_RO|LL_MPU_INSTRUCTION_ACCESS_ENABLE|LL_MPU_ACCESS_NOT_SHAREABLE|LL_MPU_ACCESS_NOT_CACHEABLE|LL_MPU_ACCESS_NOT_BUFFERABLE);
  /* Enables the MPU */
