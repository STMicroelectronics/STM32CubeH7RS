...
void HAL_MspInit(void)
{
  ...
  RCC_OscInitStruct.PLL3.PLLP = 14;  /* 688/14 = 49,142Mhz for SAI */
  RCC_OscInitStruct.PLL3.PLLQ = 8;   /* NOT USED */
  RCC_OscInitStruct.PLL3.PLLR = 14;  /* 688/14 = 49,142Mhz for SPDIFRX */
...
void HAL_SPDIFRX_MspInit(SPDIFRX_HandleTypeDef* hspdifrx)
{
  ...
  */
    ...
    PeriphClkInit.SpdifrxClockSelection = RCC_SPDIFRXCLKSOURCE_PLL3R;
    ...
    */
    ...
    GPIO_InitStruct.Alternate = GPIO_AF9_SPDIFRX;
    HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

    /* SPDIFRX DMA Init */
    /* GPDMA1_REQUEST_SPDIF_RX_DT Init */
    NodeConfig.NodeType = DMA_GPDMA_LINEAR_NODE;
    NodeConfig.Init.Request = GPDMA1_REQUEST_SPDIF_RX_DT;
    ...
    __HAL_LINKDMA(hspdifrx, hdmaDrRx, handle_GPDMA1_Channel1);
...
/* SAI1 */
  ...
  */
    ...
    */
    ...
    __HAL_LINKDMA(hsai, hdmatx, handle_GPDMA1_Channel4);
