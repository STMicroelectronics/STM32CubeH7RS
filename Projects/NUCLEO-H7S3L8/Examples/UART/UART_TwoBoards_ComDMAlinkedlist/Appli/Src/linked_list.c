...
DMA_NodeTypeDef Node1_tx __attribute__((section("noncacheable_buffer")));
DMA_QListTypeDef UART_Tx_Queue;
DMA_NodeTypeDef Node2_tx __attribute__((section("noncacheable_buffer")));
DMA_NodeTypeDef Node3_tx __attribute__((section("noncacheable_buffer")));
DMA_NodeTypeDef Node1_rx __attribute__((section("noncacheable_buffer")));
DMA_QListTypeDef UART_Rx_Queue;
DMA_NodeTypeDef Node2_rx __attribute__((section("noncacheable_buffer")));
DMA_NodeTypeDef Node3_rx __attribute__((section("noncacheable_buffer")));
