...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Transmit_DMA/Appli/Src/stm32h7rsxx_hal_msp.c
...
void HAL_PSSI_MspInit(PSSI_HandleTypeDef* hpssi)
{
  ...
  /* USER CODE BEGIN PSSI_MspInit 0 */
    /* Output LSI clock on MCO to simulate an external master clock. */
    __HAL_RCC_LSI_ENABLE();
    HAL_RCC_MCOConfig(RCC_MCO2, RCC_MCO2SOURCE_LSI, RCC_MCODIV_3);
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_5|GPIO_PIN_9;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_PSSI;
    ...
    handle_GPDMA1_Channel3.Init.Request = GPDMA1_REQUEST_PSSI;
    ...
    __HAL_LINKDMA(hpssi, hdmatx, handle_GPDMA1_Channel3);
...
void HAL_PSSI_MspDeInit(PSSI_HandleTypeDef* hpssi)
{
  ...
  /* USER CODE END PSSI_MspDeInit 0 */
    ...
    PA6     ------> PSSI_PDCK
    */
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_3|GPIO_PIN_7);

    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_3|GPIO_PIN_2);

    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_8|GPIO_PIN_5|GPIO_PIN_9|GPIO_PIN_4);
    ...
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_10|GPIO_PIN_5|GPIO_PIN_6);
