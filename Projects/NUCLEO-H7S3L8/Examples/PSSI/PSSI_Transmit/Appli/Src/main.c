...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Transmit/Appli/Src/main.c
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* Transmit operation */
    if (HAL_PSSI_Transmit(&hpssi, (uint8_t *)pData16, sizeof(pData16), 0xFFFF) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    /* Transmit operation */
    if (HAL_PSSI_Transmit(&hpssi, (uint8_t *)pData16_16lines, sizeof(pData16_16lines), 0xFFFF) != HAL_OK)
    {
      Error_Handler();
    }
