...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Master_Single_ComDMA/Appli/Src/stm32h7rsxx_hal_msp.c
...
void HAL_PSSI_MspInit(PSSI_HandleTypeDef* hpssi)
{
  ...
  */
    ...
    */
    ...
    if (HAL_DMAEx_ConfigDataHandling(&handle_GPDMA1_Channel3, &DataHandlingConfig) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    /* PSSI interrupt Init */
    HAL_NVIC_SetPriority(PSSI_IRQn, 0, 0);
