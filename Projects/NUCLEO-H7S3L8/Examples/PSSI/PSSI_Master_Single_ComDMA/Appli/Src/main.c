...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Master_Single_ComDMA/Appli/Src/main.c
...
static const uint8_t aTxBuffer[] ="Hello World!";
...
int main(void)
{
  ...
  if (HAL_PSSI_Transmit_DMA(&hpssi, (uint32_t*)aTxBuffer, TXBUFFERSIZE) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  /* Add a delay to give the receiver the time to retrieve the last data */
  HAL_Delay(1);
