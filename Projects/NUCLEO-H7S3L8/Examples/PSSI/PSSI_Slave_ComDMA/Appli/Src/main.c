...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Slave_ComDMA/Appli/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use STM32H7RSxx PSSI HAL API to
             manage a Transmission and Reception procedure in DMA mode.
  ******************************************************************************
  * @attention
  *
...
uint8_t aTxBuffer[24] = "Hello from Slave";

/* Buffer data received from Master */
static uint8_t aRxBuffer[40] __attribute__((section("noncacheable_buffer")));

/* Buffer data expected at reception */
uint8_t aRxBufferExp[] = "Hello from Slave: received by Master" ;
