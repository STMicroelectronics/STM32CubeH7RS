...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Slave_Single_ComDMA/Appli/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use STM32H7RSxx PSSI HAL API to
             manage a Reception procedure in DMA mode.
  ******************************************************************************
  * @attention
  *
...
static uint8_t aRxBuffer[RXBUFFERSIZE] __attribute__((section("noncacheable_buffer")));
...
int main(void)
{
  ...
  /* Wait for the Master to send a buffer */
