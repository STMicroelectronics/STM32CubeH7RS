...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Slave_Com/Appli/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use STM32H7RSxx PSSI HAL API to
             manage a Transmission and Reception procedure in polling mode.
  ******************************************************************************
  * @attention
  *
...
uint8_t aTxBuffer[16] = "Hello from Slave";

/* Buffer data received from Master */
static uint8_t aRxBuffer[36];
