...
/**
  ******************************************************************************
  * @file    I3C/I3C_Controller_IBI_Wakeup_IT/Appli/Src/stm32h7rsxx_hal_msp.c
...
void HAL_I3C_MspInit(I3C_HandleTypeDef* hi3c)
{
  ...
  */
    ...
    PeriphClkInit.I2c1_I3c1ClockSelection = RCC_I2C1_I3C1CLKSOURCE_HSI;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }

    /* Configure EXTI line for wakeup interrupt */
    EXTI_ConfigStructure.Line = EXTI_LINE_25;
    EXTI_ConfigStructure.Mode  =  EXTI_MODE_INTERRUPT;
    EXTI_ConfigStructure.Trigger = EXTI_TRIGGER_RISING;

    HAL_EXTI_SetConfigLine(&EXTI_HandleStructure, &EXTI_ConfigStructure);
    ...
    */
    ...
    /* I3C1 interrupt Init */
    HAL_NVIC_SetPriority(I3C1_WKUP_IRQn, 0, 0);
    HAL_NVIC_EnableIRQ(I3C1_WKUP_IRQn);
...
void HAL_I3C_MspDeInit(I3C_HandleTypeDef* hi3c)
{
  ...
  /* USER CODE END I3C1_MspDeInit 0 */
    ...
    */
    ...
    HAL_NVIC_DisableIRQ(I3C1_WKUP_IRQn);
