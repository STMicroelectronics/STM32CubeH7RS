...
DMA_NodeTypeDef Node1 __attribute__((section("noncacheable_buffer")));
DMA_QListTypeDef Queue;
DMA_NodeTypeDef Node2 __attribute__((section("noncacheable_buffer")));
DMA_NodeTypeDef Node3 __attribute__((section("noncacheable_buffer")));
...
uint32_t aDST_Buffer1[BUFFER1_SIZE] __attribute__((section("noncacheable_buffer")));
uint32_t aDST_Buffer2[BUFFER2_SIZE] __attribute__((section("noncacheable_buffer")));
uint32_t aDST_Buffer3[BUFFER3_SIZE] __attribute__((section("noncacheable_buffer")));
/* USER CODE END PM */
