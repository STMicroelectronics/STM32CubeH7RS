...
Other peripherals used:
  ...
  1 GPIO for analog input: ADC channel 2 on pin PF.11 (Arduino connector CN9 pin 11 A5, Morpho connector CN12 pin 62)
  

#### <b>Notes</b>

    Whenever the application is using ITCM/DTCM memories (@0x0000000 / @0x20000000: not cacheable and only accessible
