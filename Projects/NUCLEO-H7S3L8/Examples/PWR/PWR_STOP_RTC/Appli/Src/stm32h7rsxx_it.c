...
/**
  ******************************************************************************
  * @file    PWR/PWR_STOP_RTC/Src/stm32h7rsxx_it.c
...
/* USER CODE BEGIN EV */
/* EXTI handler declared in "hal_msp.c" file */
...
void RTC_IRQHandler(void)
{
  ...
  /* Check EXTI flags for RTC Wakeup timer */
  if (HAL_EXTI_GetPending(&hexti, EXTI_TRIGGER_RISING_FALLING) == 1U)
  {
