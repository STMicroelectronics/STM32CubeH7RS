...
The green LED ([**LD1**]{style="color: GREEN"}) is turned ON, in case the encryption/decryption and tag are
computed correctly, in case there is a mismatch the red LED is turned ON ([**LD3**]{style="color: RED"}).
...
File                                                      | Description
--- | ---
  CRYP/CRYP_AES_GCM/Appli/Inc/main.h                      |  Header for main.c module
  CRYP/CRYP_AES_GCM/Appli/Inc/stm32h7rsxx_hal_conf.h      |  HAL Configuration file
  CRYP/CRYP_AES_GCM/Appli/Inc/stm32h7rsxx_it.h            |  Interrupt handlers header file
  CRYP/CRYP_AES_GCM/Appli/Inc/stm32h7rsxx_nucleo_conf.h   |  BSP Configuration file
  CRYP/CRYP_AES_GCM/Appli/Src/main.c                      |  Main program
  CRYP/CRYP_AES_GCM/Appli/Src/stm32h7rsxx_hal_msp.c       |  HAL MSP module
  CRYP/CRYP_AES_GCM/Appli/Src/stm32h7rsxx_it.c            |  Interrupt handlers
  CRYP/CRYP_AES_GCM/Appli/Src/system_stm32h7rsxx.c        |  STM32H7RSxx system source file
