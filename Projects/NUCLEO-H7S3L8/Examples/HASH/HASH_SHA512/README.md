...
The SHA512 message digest length is 32 bytes.

The expected HASH digests (SHA512) are already computed using an online HASH tool.
...
In case the SHA512 digest is computed correctly the green LED ([**LD1**]{style="color: GREEN"}) is turned ON.
...
Security,  HASH, HMAC, SHA512, digest
...
File                                                      | Description
                                                      --- | ---
  HASH/HASH_SHA512/Appli/Inc/main.h                      |  Header for main.c module
  HASH/HASH_SHA512/Appli/Inc/stm32h7rsxx_hal_conf.h      |  HAL Configuration file
  HASH/HASH_SHA512/Appli/Inc/stm32h7rsxx_it.h            |  Interrupt handlers header file
  HASH/HASH_SHA512/Appli/Inc/stm32h7rsxx_nucleo_conf.h   |  BSP Configuration file
  HASH/HASH_SHA512/Appli/Src/main.c                      |  Main program
  HASH/HASH_SHA512/Appli/Src/stm32h7rsxx_hal_msp.c       |  HAL MSP module
  HASH/HASH_SHA512/Appli/Src/stm32h7rsxx_it.c            |  Interrupt handlers
  HASH/HASH_SHA512/Appli/Src/system_stm32h7rsxx.c        |  STM32H7RSxx system source file
