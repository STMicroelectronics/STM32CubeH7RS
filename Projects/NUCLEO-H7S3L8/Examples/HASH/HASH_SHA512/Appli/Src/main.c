...
__ALIGN_BEGIN static uint8_t aExpectSHA512Digest[64] __ALIGN_END =  {0xc5, 0xc0, 0x30, 0xcd, 0xaa, 0xcc, 0xd0, 0x2d, 0x39, 0x2a,
                                                                     0xe7, 0xbc, 0x86, 0x15, 0xae, 0x31, 0x36, 0x10, 0xbe, 0xd6,
                                                                     0x7a, 0x40, 0x12, 0x74, 0x40, 0x02, 0x14, 0xa1, 0x5c, 0xf4,
                                                                     0x43, 0x59, 0xa8, 0xc2, 0xf9, 0x77, 0x29, 0xe1, 0x57, 0xb1,
                                                                     0xaa, 0x4f, 0x32, 0xbd, 0xe2, 0x79, 0x72, 0xff, 0xde, 0x96,
                                                                     0x12, 0xd0, 0x23, 0x4d, 0x91, 0x59, 0x10, 0xec, 0x30, 0xc6,
                                                                     0xaa, 0x0b, 0xb9, 0xbf};
/* USER CODE END PV */
...
int main(void)
{
  ...
  if (HAL_HASH_Start_IT(&hhash, (uint8_t*)aInput, strlen((char const*)aInput), aSHA512Digest) != HAL_OK)
  {
    Error_Handler();
  }
