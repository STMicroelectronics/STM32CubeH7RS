...
/**
  ******************************************************************************
  * @file    I2C/I2C_TwoBoards_RestartComIT/Appli/Src/main.c
...
const char aTxBuffer[] = " ****I2C_TwoBoards advanced communication based on IT****  ****I2C_TwoBoards advanced communication based on IT****  ****I2C_TwoBoards advanced communication based on IT**** ";
...
int main(void)
{
  ...
  do
  {
    if(HAL_I2C_Master_Seq_Transmit_IT(&hi2c3, (uint16_t)I2C_ADDRESS, (uint8_t*)aTxBuffer, TXBUFFERSIZE, I2C_FIRST_FRAME)!= HAL_OK)
    {
  ...
  do
  {
    if(HAL_I2C_Master_Seq_Receive_IT(&hi2c3, (uint16_t)I2C_ADDRESS, (uint8_t *)aRxBuffer, RXBUFFERSIZE, I2C_LAST_FRAME) != HAL_OK)
    {
      /* Error_Handler() function is called when error occurs. */
      Error_Handler();
    }
  ...
  /*##- Put I2C peripheral in reception process ############################*/
  if(HAL_I2C_Slave_Seq_Receive_IT(&hi2c3, (uint8_t *)aRxBuffer, RXBUFFERSIZE, I2C_FIRST_FRAME) != HAL_OK)
  {
    /* Transfer error in reception process */
    Error_Handler();
  }
  ...
  /*  Before starting a new communication transfer, you need to check the current
      ...
      transfer, but application may perform other tasks while transfer operation
      is ongoing. */
  while (HAL_I2C_GetState(&hi2c3) != HAL_I2C_STATE_LISTEN)
  {
  }
  ...
  /* While the I2C in reception process, user can transmit data through
     "aTxBuffer" buffer */
  if(HAL_I2C_Slave_Seq_Transmit_IT(&hi2c3, (uint8_t*)aTxBuffer, TXBUFFERSIZE, I2C_LAST_FRAME)!= HAL_OK)
  {
