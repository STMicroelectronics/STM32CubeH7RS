...
![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/STM32CubeH7RS.svg?color=brightgreen)
...
```bash
git clone --recursive  --depth 1 --branch vX.Y.Z https://github.com/STMicroelectronics/STM32CubeH7RS.git
```
...
## Boards available
  ...
  * STM32H7RS
    * [STM32H7S78-DK](https://www.st.com/content/st_com/en/products/evaluation-tools/product-evaluation-tools/mcu-mpu-eval-tools/stm32-mcu-mpu-eval-tools/stm32-discovery-kits/stm32h7s78-dk.html)
    * [NUCLEO-H7S3L8](https://www.st.com/content/st_com/en/products/evaluation-tools/product-evaluation-tools/mcu-mpu-eval-tools/stm32-mcu-mpu-eval-tools/stm32-nucleo-boards/nucleo-h7s3l8.html)
